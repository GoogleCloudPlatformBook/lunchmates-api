...
class RequestSummaryHandler(webapp2.RequestHandler):
    ...
    def get(self):
    	...
    	old_pending_requests = MeetingRequest.query(MeetingRequest.state=='pending' and MeetingRequest.created < one_month_ago).order(MeetingRequest.created).fetch(100)
